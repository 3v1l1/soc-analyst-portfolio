...
| 🔍 **SIEM Brute-Force Detection** | Splunk, Linux Logs | Detects unauthorized admin access attempts using custom SPL and Regex extraction. | [View Repo](https://github.com/3v1l1/siem-bruteforce-detection) |
